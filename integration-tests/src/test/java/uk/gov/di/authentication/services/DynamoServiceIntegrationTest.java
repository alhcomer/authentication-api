...
class DynamoServiceIntegrationTest {
    ...
    void shouldGetUsersNotOnTermsAndConditionsVariousVersions() {
        ...
        assertThat(
                dynamoService
                        .getBulkUserEmailAudienceStreamNotOnTermsAndConditionsVersion(null, "1.0")
                        .count(),
                equalTo(7L));
        assertThat(
                dynamoService
                        .getBulkUserEmailAudienceStreamNotOnTermsAndConditionsVersion(null, "1.1")
                        .count(),
                equalTo(8L));
        assertThat(
                dynamoService
                        .getBulkUserEmailAudienceStreamNotOnTermsAndConditionsVersion(null, "1.2")
                        .count(),
                equalTo(7L));
        assertThat(
                dynamoService
                        .getBulkUserEmailAudienceStreamNotOnTermsAndConditionsVersion(null, "1.3")
                        .count(),
                equalTo(8L));
